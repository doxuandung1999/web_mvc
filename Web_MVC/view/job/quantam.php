...
<html>
    <head>
        ...
        <meta charset="utf-8">
        <link rel="stylesheet" href="./css_sp/quantam_1.css" type="text/css">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-0" id="dangnhap">
                        <ul>
                            ...
                            <li id="dangxuat">
                                <a href="index.php?controller=job&action=quantam&ac=logout"><i class="fas fa-sign-out-alt"></i>  Đăng xuất</a>
                            </li>
                        </ul>
                    </div>
                </div>
           ...
           <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="index.php?controller=job&action=quantam&delete=<?php echo $array["id_cv"];?>" style="color: black; font-size: 20px;"><i class="fas fa-trash"></i></a></td>
                    </tr>
                            <?php
                                endwhile;
                            ?>
